    ...
    <div ref={commentRef} className="flex flex-col">
      ...
      {isReplying ? (
        <div className="grid w-full gap-1.5">
          ...
          <div className="mt-2">
            <Textarea onFocus={e => e.currentTarget.setSelectionRange(e.currentTarget.value.length, e.currentTarget.value.length)} autoFocus id="comment" value={input} onChange={e => setInput(e.target.value)} rows={1} placeholder="What are your thoughts?" />
